...
- Using a larger data set from more T20I matches - use statistical modelling, e.g., logistic regression, to understand the relative importance of various performance indicators.
